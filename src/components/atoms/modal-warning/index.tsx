...
interface ModalState extends Required<Omit<ModalConfig, 'onConfirm' | 'onCancel'>> {
  isOpen: boolean;
  isLoading: boolean;
...
const ModalWarningInfoContext = createContext<ModalContextType | undefined>(undefined);
