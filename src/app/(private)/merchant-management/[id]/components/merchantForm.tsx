...
import MerchantFormSkeleton from './skeletonLoading';
...
export default function MerchantForm() {
  ...
  return (
    <>
      {loadingMerchant && <BlockingLoader />}
      {isLoadingMerchantById ? (
        ...
        <form onSubmit={handleSubmit(onSubmit, onInvalid)} className="w-full flex flex-col gap-6">
          ...
          {fields.map((field, index) => (
            <div key={field.id} className="w-full flex flex-col bg-white rounded-md shadow">
              <div className="flex w-full gap-2 items-center justify-between p-4 border-b">
                <div className="flex gap-2 items-center">
                  <PersonIcon className="text-blue-500" />
                  <p className="text-md text-black font-medium">
                    Person in Charge (PIC) {index + 1}
                  </p>
                </div>
                {fields.length > 1 && (
                  <button
                    ...
                    className="flex items-center gap-1 px-3 py-1.5 text-sm text-red-600 hover:bg-red-50 rounded-md transition-colors cursor-pointer"
                  >
                    ...
                    <Controller
                      ...
                      render={({ field }) => (
                        <CInput
                          ...
                          error={!!errors.pics?.[index]?.department}
                        />
                      )}
                    />
                  </div>
                    ...
                    <Controller
                      ...
                      render={({ field }) => (
                        <CInput
                          ...
                          error={!!errors.pics?.[index]?.position}
                        />
                      )}
                    />
                    <Controller
                      ...
                      render={({ field }) => (
                        <CInput
                          ...
                          error={!!errors.pics?.[index]?.phone}
                        />
                      )}
                    />
                    <Controller
                      name={`pics.${index}.office_phone`}
                      control={control}
                      render={({ field }) => (
                        <CInput
                          {...field}
                          ...
                          error={!!errors.pics?.[index]?.office_phone}
                        />
                      )}
                    />
                  </div>
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 p-4 bg-blue-50 hover:bg-blue-100 text-blue-600 rounded-md border-2 border-dashed border-blue-300 transition-colors"
          >
            <AddIcon />
            <span className="font-medium">Tambah PIC</span>
          </button>
